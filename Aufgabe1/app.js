class DiscAnimationApp {
  constructor() {
    ...
    this.discFrames = [
      { angle: 0, url: 'ESA1_1-02.png' },
      { angle: 15, url: 'ESA1_1-25.png' },
      { angle: 30, url: 'ESA1_1-24.png' },
      { angle: 45, url: 'ESA1_1-23.png' },
      { angle: 60, url: 'ESA1_1-22.png' },
      { angle: 75, url: 'ESA1_1-21.png' },
      { angle: 90, url: 'ESA1_1-20.png' },
      { angle: 105, url: 'ESA1_1-19.png' },
      { angle: 120, url: 'ESA1_1-18.png' },
      { angle: 135, url: 'ESA1_1-17.png' },
      { angle: 150, url: 'ESA1_1-16.png' },
      { angle: 165, url: 'ESA1_1-15.png' },
      { angle: 180, url: 'ESA1_1-14.png' },
      { angle: 195, url: 'ESA1_1-13.png' },
      { angle: 210, url: 'ESA1_1-12.png' },
      { angle: 225, url: 'ESA1_1-11.png' },
      { angle: 240, url: 'ESA1_1-10.png' },
      { angle: 255, url: 'ESA1_1-09.png' },
      { angle: 270, url: 'ESA1_1-08.png' },
      { angle: 285, url: 'ESA1_1-07.png' },
      { angle: 300, url: 'ESA1_1-06.png' },
      { angle: 315, url: 'ESA1_1-05.png' },
      { angle: 330, url: 'ESA1_1-04.png' },
      { angle: 345, url: 'ESA1_1-03.png' }
    ];
